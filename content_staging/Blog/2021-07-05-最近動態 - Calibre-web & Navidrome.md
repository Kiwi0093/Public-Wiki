...
針對之前的Server使用,我真的開始了使用docker的道路,並且參考了一些網路上的`Self-hosted`服務,挑選了兩個服務來使用

* ## <ruby>電子書管理系統<rt style="color:orange">Calibre-Web</rt></ruby>

* ## <ruby>音樂串流<rt style="color:orange">Navidrome</rt></ruby>
